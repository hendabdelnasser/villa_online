...
@Component({
  selector: 'app-clients-invoice',
  templateUrl: './clients-invoice.component.html',
  styleUrls: ['./clients-invoice.component.scss']
})
export class ClientsInvoiceComponent implements OnInit {
  clients:UserModel[] = [];
